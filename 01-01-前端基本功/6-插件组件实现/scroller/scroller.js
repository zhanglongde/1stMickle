...
function Scroller(container, options) {
  ...
  // console.log(component.clientHeight, content.offsetHeight)
    ...
    if (self.__isDragging) {
      ...
      if (self.__isSingleTouch && (timeStamp - self.__lastTouchMove) <= 100) {
        ...
        if (startPos !== endPos) {
          ...
          console.log(positions, startPos, endPos, self.__scrollTop)
          console.log(`[${timeOffset}          ${movedTop}]`)
